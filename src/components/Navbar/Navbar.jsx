...
function Navbar() {
  ...
  <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse w-36">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
      <li>
        <a href="#" className="text-gray-500 bg-blue-700 rounded md:bg-transparent md:text-gray-500 md:p-0 md:hover:text-slate-400 md:hover:border-b-2" aria-current="page">
            Home</a>
      </li>
      <li>
        <a href="#" className="md:bg-transparent md:text-gray-500 md:p-0 md:hover:text-slate-400 md:hover:border-b-2">
            Events</a>
      </li>
      <li>
        <a href="#" className="md:bg-transparent md:text-gray-500 md:p-0 md:hover:text-slate-400 md:hover:border-b-2">
